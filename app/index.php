...
<body>   
  ...
  <header class="header fixed-top">
    ...
    <nav>
      ...
      <a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="sacola bi bi-bag-fill" viewBox="0 0 16 16"><path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z"/></svg></a>
...
<!---------------------------------------------------------------CABEÇALHO INF----------------------------------------->
      ...
      <nav class="cabecalho" id="navbar">
        <div class="links">
          <ul>
            <li><a class="#" href="header.php">Home</a></li>
            <li><a href="#">Perfumes</a></li>
            <li><a href="#">Promoções</a></li>
            <li><a href="#">Refil</a></li>
            <li><a href="#">Kits</a></li>
  ...
  <div class="row">
            <div class="owl-carousel owl-theme">
               ...
               <div class="item">
                  <div class="card">
                    ...
                    <div class="content">
                      <div class="productName">
                      <a href="login.php"><h3>Produto - 2</h3></a>
                      </div>
                      <div class="price_rating">
                        <h2>R$13,45</h2>
                      </div>
             ...
             <div class="item">
                <div class="card">
                  ...
                  <div class="content">
                    <div class="productName">
                    <a href="login.php"><h3>Produto - 4</h3></a>
                    </div>
                    <div class="price_rating">
                      <h2>R$13,45</h2>
                    </div>
           ...
           <div class="item">
              <div class="card">
                ...
                <div class="content">
                  <div class="productName">
                  <a href="login.php"><h3>Produto - 6</h3></a>
                  </div>
                  <div class="price_rating">
                    <h2>R$13,45</h2>
                  </div>
