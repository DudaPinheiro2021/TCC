...
$sql = "INSERT INTO usuarios(nome,email,senha,telefone,data_nasc)
VALUES('$nome','$email','$senha','$telefone','$data_nasc')";
...
if($result==1){
    ...
    header("Location:../app/endereco.html");
}
   ...
   <body>
      <div class="questionario">
         ...
         <div class="form-inner">
            ...
            <form action="endereco.html" class="signup" method="POST">
               ...
               <div class="enviar">
                  <input type="submit" value="Seguir" name="submit" id="submit">
               </div>
